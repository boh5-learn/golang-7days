...
// SetFuncMap set template.FuncMap to engine
...
// createStaticHandler returns HandlerFunc to start http.FileServer
...
// Static register a root dir url to RouterGroup
